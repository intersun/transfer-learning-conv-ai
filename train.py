...
from utils import average_distributed_scalar, get_data_loaders, update_full, inference_full
...
def train():
    ...
    parser.add_argument("--no_persona", type=bool, default=False, help="keep persona in training or not ")
    ...
    train_loader, val_loader, train_sampler, valid_sampler = get_data_loaders(args, tokenizer, no_persona=args.no_persona)
    ...
    inference = partial(inference_full, args=args, model=model, tokenizer=tokenizer)
